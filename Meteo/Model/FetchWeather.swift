...
//    func getMyWeatherDataByCity(forCity city: String, completion: @escaping (WeatherModel) -> ()){
//            
...
//                    self.getMyWeatherData(forLatitude: coordinate.0, forLongitude: coordinate.1, completion: { weather in
//                        completion(weather)
//                    })
//                case .failure(let error):
//                    print(error.localizedDescription)
