...
extension CurrentWeatherView {
    ...
    func setupColorViewAtCondition(_ condition: WeatherGeneralManager.WeatherCondition) {
        ...
        case .pioggia:
            ...
            weatherImage.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            sunsetImage.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            sunsetImage.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            degrees.textColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            sunriseTime.textColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            sunsetTime.textColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
        case .pioggiaLeggera:
            locationName.textColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            population.textColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            weatherImage.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
